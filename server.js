...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    // If Gemini decided to search, groundingMetadata carries what it
    // searched and which pages it drew from — surface that so the
    // frontend can show real sources instead of an unverifiable claim.
